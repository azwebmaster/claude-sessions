...
- Opens a session to show:
  ...
  - **Agent ↔ tool diagram** — interactive radial view (root centered; agent circle size = peak context or total tokens; tool size = attributed growth; link weight = call volume; expand to show all tools; zoom, pan, drag to rearrange; Arrange to auto-layout)
